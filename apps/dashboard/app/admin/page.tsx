...
import { getAdminAccess, getAdminCustomer, getAdminCustomers, getAdminOverview, getAdminUsage, type AdminCustomer, type AdminCustomerDetail, type AdminOverview, type AdminUsage } from "../lib/api-client";
...
export default function AdminPage() {
  ...
  async function loadAdminData(token: string) {
    ...
    try {
      ...
      const [overviewResponse, usageResponse] = await Promise.all([getAdminOverview(token), getAdminUsage(token)]);
      setOverview(overviewResponse.overview); setUsage(usageResponse.usage); setIsAdmin(true);
    } catch (requestError) {
