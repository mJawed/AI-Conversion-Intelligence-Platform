...
export function RealtimeCard() {
  return (
    <section className="widget realtime-widget" aria-labelledby="realtime-heading">
      ...
      <div className="realtime-number">37 <span>visitors</span></div>
      <div className="realtime-bar"><span style={{ width: "67%" }} /></div>
      <div className="realtime-meta"><span>67% on mobile</span><span>Peak: 52</span></div>
      <div className="current-pages"><div><span className="page-dot" /> /pricing <strong>14</strong></div><div><span className="page-dot" /> / <strong>9</strong></div><div><span className="page-dot" /> /features <strong>7</strong></div></div>
    </section>
  );
}
...
export function InsightPreview({ insights }: Readonly<{ insights: InsightPreview[] }>) {
  return (
