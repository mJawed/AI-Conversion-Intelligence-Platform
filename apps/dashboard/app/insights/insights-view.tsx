...
export function InsightsView({ insights, live = false, onStatusLive }: Readonly<{ insights: AIInsight[]; live?: boolean; onStatusLive?: (insightId: string, status: AIInsight["status"]) => Promise<void> }>) {
