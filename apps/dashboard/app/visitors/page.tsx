...
type LiveVisitor = { visitor_id: string; last_seen: string; sessions: number; events: number; conversions: number; current_page: string; device?: Visitor["device"]; browser?: string; source?: string; scrollDepth?: number };
