...
Before a streaming upgrade, the SDK provides a lightweight visible-page
heartbeat immediately on startup, when a hidden tab becomes visible, and every
30 seconds so idle visitors remain visible within the current five-minute
activity window.
